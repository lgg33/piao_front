        ...
        <section class="fl t-infor-box c-desc-content">
          <div class="mt20 ml20">
            <section class="t-infor-pic">
              <img :src="teacher.avatar" :alt="teacher.name" style="height: 200px; width: 200px">
            </section>
            <h3 class="hLh30">
...
<script>
  ...
  export default {
    ...
    methods: {
      async fetchData() {
        const { data } = await teacher.getById(this.$route.params.id)
        console.log(data);
      }
    }*/
    asyncData({ params, error }) {
      return teacher.getById(params.id)
      .then(response => {
